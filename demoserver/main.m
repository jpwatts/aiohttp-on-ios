...
int main(int argc, char *argv[]) {
    ...
    @autoreleasepool {
        ...
        main_script = [
                [[NSBundle mainBundle] pathForResource:@"Library/Application Support/com.joelwatts.aiohttp-on-ios.demoserver/app/demoserver/app"
                                                ofType:@"py"] cStringUsingEncoding:NSUTF8StringEncoding];

        if (main_script == NULL) {
            NSLog(@"Unable to locate demoserver main module file");
            exit(-1);
        }
